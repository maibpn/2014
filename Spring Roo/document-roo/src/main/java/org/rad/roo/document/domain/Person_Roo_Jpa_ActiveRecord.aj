...
privileged aspect Person_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Person.fieldNames4OrderClauseFilter = java.util.Arrays.asList("id", "gender", "firstName", "mName", "lastName", "jobTitle", "prefix", "suffix", "electronicAddress", "mobilePhone", "fax", "landLinePhone", "personalAddress", "documents");

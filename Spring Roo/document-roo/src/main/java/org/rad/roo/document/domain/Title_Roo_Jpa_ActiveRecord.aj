...
privileged aspect Title_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Title.fieldNames4OrderClauseFilter = java.util.Arrays.asList("speech", "text");
    ...
    public static List<Title> Title.findAllTitles(String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM Title o";
        ...
        return entityManager().createQuery(jpaQuery, Title.class).getResultList();
    }
    ...
    public static List<Title> Title.findTitleEntries(int firstResult, int maxResults, String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM Title o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
        ...
        return entityManager().createQuery(jpaQuery, Title.class).setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }

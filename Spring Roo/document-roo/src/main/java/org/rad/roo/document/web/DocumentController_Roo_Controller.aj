...
import org.rad.roo.document.web.DocumentController;
...
privileged aspect DocumentController_Roo_Controller {
    ...
    void DocumentController.populateEditForm(Model uiModel, Document document) {
        ...
        uiModel.addAttribute("descriptions", Description.findAllDescriptions());
        uiModel.addAttribute("documentclassifications", DocumentClassification.findAllDocumentClassifications());
        uiModel.addAttribute("documentids", DocumentId.findAllDocumentIds());
        uiModel.addAttribute("documentrelationships", DocumentRelationship.findAllDocumentRelationships());
        uiModel.addAttribute("documentrevisions", DocumentRevision.findAllDocumentRevisions());
